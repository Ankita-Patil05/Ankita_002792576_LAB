...
public class MainJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        assignBtn.setText("Assigned Medicine");
        assignBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                assignBtnActionPerformed(evt);
            }
        });
        ControlJPanel.add(assignBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 340, 140, 30));
        ...
        ControlJPanel.add(createObservationBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 120, 140, 30));
        ...
        ControlJPanel.add(viewVitalsBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 200, 140, 30));

        medCatalogBtn.setBackground(new java.awt.Color(255, 255, 153));
        medCatalogBtn.setText("Medicin Catalog");
        medCatalogBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                medCatalogBtnActionPerformed(evt);
            }
        });
        ControlJPanel.add(medCatalogBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 270, 140, 30));
